...
export const TUNING = {
  ...
  ECONOMY: {
    ...
    SPONSOR_BASE: { kucuk: 7, orta: 24, buyuk: 45, dev: 68, efsane: 95 }, // göğüs baz (sezonluk mn). 2026-07-24 (kullanıcı "sponsor haftalık gelirini bir tık artıralım"): küçük 6→7, orta 22→24 (ekonomiye nefes); BÜYÜK+ DOKUNULMADI (zaten net bandında — 51'e çıkarınca büyük net %36 ile bandı deldi)
